...
<head>
    ...
    <style type="text/css">
    	...
    	.bardddl{
            ...
            padding: 39px 0 0 0;
            margin: 18px 0 0 0;
            background: transparent url(./images/dddl.png) no-repeat 0 -244px;
            text-align: center;
            line-height: 39px;
            color: #fff;
    ...
    <div class="toppic">
        <div class="topside">
            ...
            <ul id="topNav" class="topNav">
                <li class="current"><a pgv="//localhost:8080/webtest/qq.jsp" href="//localhost:8080/webtest/qq.jsp">首页</a></li>
                <li><a href="http://localhost:8080/webtest/login.jsp">猜你喜欢</a></li>
                <li><a href="http://localhost:8080/webtest/login.jsp">个人信息</a></li>
                 
            </ul>
        </div>
        <div class="topTool">
            <a class="barzc"  href="http://localhost:8080/webtest/register.jsp" >注册</a>
            <a class="barzcdl"  href="http://localhost:8080/webtest/login.jsp" >登录</a>
			...
			<script language="javascript">
				...
				{
					var login=false;
					var name=window.prompt("请输入用户名","用户名");
					var mima=window.prompt("请输入密码","密码");
					if(window.confirm("请确认是否要登录")){
      			      <%
      			    		boolean logintest=false; 
      					    //String name=request.getParameter("name");
     				       //	String mima=request.getParameter("mima");
     				       //	if(name.equals("用户名")&&mima.equals("密码")){
     				       	//	logintest=true;
     				       	//}
    			       %>
					...
					if(login){
						window.location.href="http://localhost:8080/webtest/qq.jsp"; 
					}
			...
			<script language="JavaScript">
 				...
 				function openwin() {
 					window.open ("login.jsp", "newwindow", "height=600, width=600, toolbar=0, menubar=0, scrollbars=0, resizable=0, location=0, status=0 ,titlebar=0,directories=0,left=500px,top=100px");
        ...
        <a class="barddzc"  href="http://localhost:8080/webtest/Oregister.jsp" ></a>
       	<a class="bardddl"  href="http://localhost:8080/webtest/Ologin.jsp" ></a>
    </div>
</div>
...
<div> 小组成员：崔雨豪	武恺莉		魏文选		姬姣姣    王志鹏		褚丹阳</div>
