    ...
    <div class="toppic">
        <div class="topside">
            ...
            <ul id="topNav" class="topNav">
                <li class="current"><a href="//localhost:8080/webtest/Uloginqq.jsp">首页</a></li>
                <li><a href="http://localhost:8080/webtest/like.jsp">猜你喜欢</a></li>
                <li><a href="http://localhost:8080/webtest/register_findById.action">个人信息</a></li>
            </ul>
        </div>
        <div class="topTool">
     		<% String a="cyhbrilliant";%>            、
			<div class="ttxt">您好，${sessionScope.username}</div>
