...
<html>
  ...
  <body>
    ...
    <s:form action="register" method="post">  
        ...
        <s:textfield name="user.username"  class="username"></s:textfield> 
        <div class="stxt">密码</div> 
        <s:password name="user.password"  class="secret"></s:password> 
        <div class="atxt">真实姓名</div>
        <s:textfield name="user.truthname"  class="age"></s:textfield> 
        <div class="ttxt">电话</div>
        <s:textfield name="user.tel"  class="tel"></s:textfield>
