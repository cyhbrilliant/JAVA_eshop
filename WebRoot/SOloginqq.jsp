    ...
    <div class="toppic">
        <div class="topside">
            ...
            <ul id="topNav" class="topNav">
                <li class="current"><a href="//localhost:8080/webtest/SOloginqq.jsp">首页</a></li>
                <li><a href="" onclick="openwin()">发布商品</a></li>          
                <li><a href="http://localhost:8080/webtest/oregister_SfindById.action?id=${owner.id}">个人信息</a></li>
                 <li><a href="http://localhost:8080/webtest/ssubmit.jsp?oid=${owner.id}">查看发布</a></li>
            </ul>
        </div>
        ...
        <div class="topTool">
			...
			<div class="ttxt">欢迎回来，${sessionScope.owner.getOname()} </div>
