  ...
  <head>
	...
	<meta http-equiv="description" content="This is my page">
       ...
       .pic{
            ...
            height: 900px;
            padding-top: 0px;
            background: url(./images/like2.jpg) no-repeat 0 0;
            z-index: 1;    
  ...
  <body>
	<a class="logoLink"></a>
  	...
  	<%
    	...
    	List<Goods> allgoods=goodsHibernate.findAllGoods();
    	int allsize=0;
    	if(allgoods.size()>=20){
    		allsize=10;
    	}
    	else{
    		allsize=(int)allgoods.size()/2+1;
    	}
    	
    	List<Goods> goods=new ArrayList<Goods>();	
    	for (int i=0;i<allsize;i++){
    		int random=(int)Math.random()*allgoods.size();
    		goods.add(allgoods.get(random));
    	}
  			...
  			<div class="buy" onclick="onbuy()">
  				...
  				function onbuy(){
						...
						var id=4*rows+cols;
	       				...
	       				window.location.href ("buysuccess.jsp?id="+id);
         			}
  				</script>
