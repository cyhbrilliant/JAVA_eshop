...
<%@page import="com.shop.beans.Owner"%>
...
<head>
    ...
    <style type="text/css">
        ...
        .topTool {
            ...
            height: 76px;
            font-size: 0.875em;
            background: transparent url(./images/Ologin.png) no-repeat 0 -244px;
        }
    ...
    <div class="toppic">
        <div class="topside">
            ...
            <ul id="topNav" class="topNav">
                <li class="current"><a href="//localhost:8080/webtest/Ologinqq.jsp">首页</a></li>
                <li><a href="" onclick="openwin()">发布商品</a></li>          
                <li><a href="http://localhost:8080/webtest/oregister_findById.action">个人信息</a></li>
                
            </ul>
            <a class="looksub" href="http://localhost:8080/webtest/ssubmit.jsp?oid=${owner.id}">查看发布</a>
        </div>
        
        <script language="JavaScript">	
 			function openwin() {
 				window.open ("submit.jsp?id=${owner.id}", "newwindow", "height=550, width=350, toolbar=0, menubar=0, scrollbars=0, resizable=0, location=0, status=0 ,titlebar=0,directories=0,left=500px,top=100px");
 			}
 		</script>
        <div class="topTool">
     		<% String a="cyhbrilliant";%>            、
			<div class="ttxt">欢迎回来，${sessionScope.oname}</div>
